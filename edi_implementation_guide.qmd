...
To let carrier know when a member is no longer enrolled through the administrator but has not terminated their coverage, the administrator will send an update type enrollment transaction with additional maintenance reason code (AMRC) LEAVE\_PLATFROM on an inbound enrollment transaction in the AMRC field of the 2750 Loop.
...
- File type: 834 EDI  
- File spec: Please reach out to [ichra@hioscar.com](mailto:ichra@hioscar.com) for companion guide information.
- Cadence: Daily batch  
